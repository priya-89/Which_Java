...
public class CustomReport implements IReporter {
    ...
    private static SimpleDateFormat filedate = new SimpleDateFormat("yyyy_MM_dd_hh_mm_ss_a");
    private static String outFilename = "cus_report_" + getDateAsStringForFileName() + "_" + "custom-report.html";
    ...
    protected static String getDateAsStringForFileName() {
        Date date = new Date();
        //  filedate.setTimeZone( TimeZone.getTimeZone( timeZone ) );
        return filedate.format(date);
    }
    ...
    protected void writeSuiteSummary() {
        ...
        writer.print("<table>");
        writer.print("<tr>");
        writer.print("<th>Test Modules</th>");
        writer.print("<th>Passed</th>");
        writer.print("<th>Skipped</th>");
        writer.print("<th>Failed</th>");
        writer.print("<th>Execution time</th>");
    ...
    protected void writeScenarioSummary() {
        ...
        writer.print("<thead>");
        writer.print("<tr>");
        writer.print("<th>Modules</th>");
        writer.print("<th>Test Scenarios</th>");
    ...
    private void writeScenario(int scenarioIndex, String label,
        ...
        if (!reporterMessages.isEmpty()) {
            ...
            // Need to implement screenshot here
